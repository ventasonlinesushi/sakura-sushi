...
function saveNewOrder(){
  ...
  if(t==="restaurante"){if(!mesa||mesa<1){toast("Ingresa un numero de mesa valido");return}var ocupada=cuentaActivaEnMesa(mesa,null);if(ocupada){toast("Mesa "+mesa+" ya tiene la cuenta #"+ocupada.folio+" abierta. Usa Agregar platillos.");state.selectedOrderId=ocupada.id;$("newOrderModal").classList.add("hidden");render();return}addr="Mesa "+mesa;name=addr}else if(t==="domicilio"){addr=($("noAddr").value||"").trim()}
