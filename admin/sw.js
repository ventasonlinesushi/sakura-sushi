const CACHE="sakura-pos-mobile-v12";
const ASSETS=["./","index.html","admin.css?v=pos8","admin.js?v=pos9","manifest.json","icon-192.png","icon-512.png","../js/config/brand-config.js","../js/data/menu-data.js","../logo.png"];
