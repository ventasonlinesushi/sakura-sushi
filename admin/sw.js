const CACHE="sakura-pos-mobile-v10";
const ASSETS=["./","index.html","admin.css?v=pos7","admin.js?v=pos8","manifest.json","icon-192.png","icon-512.png","../js/config/brand-config.js","../js/data/menu-data.js","../logo.png"];
