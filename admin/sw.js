const CACHE="sakura-pos-mobile-v21";
const ASSETS=["./","index.html","admin.css?v=pos11","admin.js?v=pos16","menu-config.js?v=pos10","manifest.json","icon-192.png","icon-512.png","../js/config/brand-config.js","../js/data/menu-data.js?v=menu2x150-1","../js/services/menu-options-service.js?v=2","../logo.png"];
