const CACHE="sakura-pos-mobile-v13";
const ASSETS=["./","index.html","admin.css?v=pos8","admin.js?v=pos10","menu-config.js?v=pos10","manifest.json","icon-192.png","icon-512.png","../js/config/brand-config.js","../js/data/menu-data.js","../js/services/menu-options-service.js?v=2","../logo.png"];
