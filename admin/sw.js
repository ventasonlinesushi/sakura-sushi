const CACHE="sakura-pos-mobile-v16";
const ASSETS=["./","index.html","admin.css?v=pos9","admin.js?v=pos12","menu-config.js?v=pos10","manifest.json","icon-192.png","icon-512.png","../js/config/brand-config.js","../js/data/menu-data.js","../js/services/menu-options-service.js?v=2","../logo.png"];
